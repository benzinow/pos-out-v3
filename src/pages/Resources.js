...
export function Resources() {
  return (
    <div className="resources">
      <h1 className="page-title">Life Changing Resources</h1>
      <div className="resource-cards">
        <div className="pitch-block">
          <p className="pitch">
            As a two-time cancer survivor, prioritizing my health has been
            paramount. I had the privilege of being part of the staff and a
            speaker at the world's premier detox spa, where people from all
            corners of the globe flock to experience its incredible benefits.
          </p>
          <p className="pitch">
            Three practices have become my guiding principles when it comes to
            maintaining optimal health.
          </p>
          <p className="pitch">
            First and foremost, let me emphasize the profound impact of Kangen
            alkalized water. Through extensive research and personal experience,
            I have discovered its unparalleled qualities, making it a true
            game-changer.
          </p>
          <p className="pitch">
            Pairing Kangen alkalized water with daily organic green drinks is a
            practice I wholeheartedly recommend. These drinks are a treasure
            trove of nutrients, capable of working wonders for your well-being.
            Don't just take my word for it – scientific research, personal
            testimonials, and countless success stories attest to their
            efficacy.
          </p>
          <p className="pitch">
            Lastly, let me introduce you to the Relax infrared sauna, a
            transformative experience that has profoundly affected my journey.
            This sauna operates on a whole new level, setting it apart from
            traditional alternatives. Discover how its unique features and
            benefits can elevate your well-being and rejuvenate your body and
            mind.
          </p>
          <p className="pitch">
            For more in-depth information on these practices, including
            scientific findings, personal anecdotes, and testimonials, don't
            hesitate to reach out. I want you to feel informed and empowered as
            you explore these excellent health practices.
          </p>
          <p className="pitch">
            As a special treat, I've secured a $100.00 discount for anyone who
            uses the code word "POSITIVE" when purchasing the sauna. Take
            advantage of this exclusive opportunity to enhance your well-being.
          </p>
          <p className="pitch">
            Thank you for joining me on this journey toward a healthier and more
            positive life. Should you have any questions or need further
            guidance, I'm here to help.
          </p>
          <p className="pitch">
            Stay healthy, stay positive, and embrace the transformative power of
            these extraordinary health practices!
          </p>
        ...
        <div className="link-cards">
          ...
          <div className="discount-card book-list">
            <a
              className="book"
            ...
            >
              ...
              <br />
              to save $100 on your Relax infrared sauna.
            </a>
          </div>
          ...
          <div className="discount-card book-list">
            <h3>Books I reccommend studying:</h3>
            <a
              className="book"
              target="_blank"
              rel="noreferrer"
            ...
            >
              “The Water Puzzle and the Hexagonal Key” <br />
              by Dr. Mu Shik Jhon
            </a>
            <a
              className="book"
